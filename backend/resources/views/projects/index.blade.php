...
{{-- CHANGED: Header sejajar antara judul dan tombol tambah --}}
<div class="project-index-header">
    <div>
        <h2>Daftar Project</h2>
        {{-- CHANGED: Subtitle informatif di bawah heading --}}
...
{{-- CHANGED: Empty state jika belum ada project --}}
@if($projects->isEmpty())
...
@else
    ...
    @foreach($projects as $project)
        <div class="card app-card">
            ...
            {{-- CHANGED: Nama project --}}
            <h4>{{ $project->nama_project }}</h4>

            {{-- CHANGED: Meta info — kategori, total risk, dan badge breakdown per level --}}
            <div class="project-meta">
                ...
                {{-- CHANGED: Badge breakdown hanya tampil jika ada risk --}}
            ...
            {{-- CHANGED: Divider tipis sebelum tombol --}}
            <div class="project-card-divider"></div>

            {{-- CHANGED: Tombol aksi dengan hierarki visual yang lebih jelas --}}
