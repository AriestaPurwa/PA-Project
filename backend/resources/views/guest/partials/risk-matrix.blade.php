@php
    ...
    $getRiskLevel = function ($impact, $probability) {
    ...
    for ($impact = 1; $impact <= 5; $impact++) {
        for ($probability = 1; $probability <= 5; $probability++) {
            ...
            $color = $getRiskLevel($impact, $probability);
...
<div class="matrix-section">
    ...
    <div class="matrix-intro">
        ...
        <p class="matrix-description">
            ...
            <strong>Probability</strong> atau kemungkinan terjadinya risiko
            dan <strong>Impact</strong> atau besarnya dampak risiko.
    ...
    <div class="matrix-wrapper">
        ...
        <div class="risk-matrix">
            ...
            @for ($probability = 1; $probability <= 5; $probability++)
                ...
                <div class="header"
                     title="{{ $likelihoodLabels[$probability] }}">
            ...
            @for ($impact = 5; $impact >= 1; $impact--)
                ...
                @for ($probability = 1; $probability <= 5; $probability++)
                    ...
                    <div class="cell {{ $color }}"
                         title="Impact {{ $impact }} ({{ $impactLabels[$impact] }}) | Probability {{ $probability }} ({{ $likelihoodLabels[$probability] }}) | Jumlah risk: {{ $value }}">
